...
import { reducers } from "./actions.js?v=20260513-preset-group-select-1";
import { initShell, toast } from "./ui-shell.js?v=20260513-preset-group-select-1";
import { initRecipeTab } from "./ui-tab-recipe.js?v=20260513-preset-group-select-1";
import { initPriceTab } from "./ui-tab-price.js?v=20260513-preset-group-select-1";
import { initResultTab } from "./ui-tab-result.js?v=20260513-preset-group-select-1";
